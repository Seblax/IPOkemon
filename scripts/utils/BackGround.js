...
function SetBackgroundSprites() {
    ...
    const enemySprite = new Sprite(path + index + "_enemy.png", screen, Config.screen.width - 126, 64);
    const allaySprite = new Sprite(path + index + "_allay.png", screen, -64, Config.screen.height - 32);
